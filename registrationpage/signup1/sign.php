...
$sql = "insert into 'registrationform'(username,password)
...
$result = mysqli_query($con, $sql);
  ...
  $sql = "select * from 'registaration' where username='username'";
  $result = mysqli_query($con, $sql);
  if($result){
...
if($user){
  ...
  <strong>same data input again</strong> user already exist
...
?>
  ...
  <button type="sign up" class="btn btn-primary w-100">Submit</button>
</form>
    </div>
